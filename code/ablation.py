...
class Config:
    ...
    USER_EMBEDDINGS_PATH = (f"../data/{DATASET}/bert_short_term_user_profiles.pkl" if DATASET == 'movies' else f"../data/{DATASET}/bert_short_term_user_profiles_train.pkl")
