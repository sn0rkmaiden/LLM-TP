...
# -------------------
class Config:
    # User description: stable long-term preferences, used as the user representation
    ...
    CONTEXT_PATH = f"../data/{DATASET}/bert_context_profiles_test.pkl"
    ...
    RUN_NAME = f"context_rec_{DATASET}"
